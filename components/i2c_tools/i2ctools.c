...
static int do_i2chelp_cmd(int argc, char **argv)
{    
    printf("\n ==============================================================\n");
...
static void register_i2ctools_help(void) {
        const esp_console_cmd_t i2cdetect_cmd = {
        .command = "i2chelp",
        .help = "i2ctool help information",
        .hint = NULL,
        .func = &do_i2chelp_cmd,
        .argtable = NULL
    };
...
void i2ctools_init(void)
{
    ...
    register_i2ctools();
    register_i2ctools_help();

    printf("\n ==============================================================\n");
    printf(" |             Steps to Use i2c-tools                         |\n");
    printf(" |                                                            |\n");
    printf(" |  1. Try 'help', check all supported commands               |\n");
    printf(" |  1. Try 'i2chelp', check all supported commands               |\n");
    printf(" |  2. Try 'i2cconfig' to configure your I2C bus              |\n");
    printf(" |  3. Try 'i2cdetect' to scan devices on the bus             |\n");
    printf(" |  4. Try 'i2cget' to get the content of specific register   |\n");
    printf(" |  5. Try 'i2cset' to set the value of specific register     |\n");
